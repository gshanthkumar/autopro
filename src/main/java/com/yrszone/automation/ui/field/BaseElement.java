...
public abstract class BaseElement {
    ...
    protected BaseElement(final UIWebDriver webDriver, final FindBy findBy, final String findByValue) {
    ...
    public UIWebDriver getWebDriver() {
        return webDriver;
    }

    public void setWebDriver(UIWebDriver webDriver) {
        this.webDriver = webDriver;
    }
